pipeline {
    ...
    stages {
        ...
        stage('Helm Chart Deployment'){
            steps{
                bat "helm upgrade --install --force nagp-assignments aditya-nagp-assignments --set domain=localhost --set image=dtr.nagarro.com:443/adityakumar666/java_app:$BUILD_NUMBER"
            }
        }
    }
}
